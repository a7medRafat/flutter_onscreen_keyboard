...
/// Standard Russian desktop keyboard layout (ЙЦУКЕН).
///
/// This layout mirrors the common Windows/macOS hardware layout including
/// Russian-specific punctuation such as `№`, `;`, `?`, etc.
/// Includes a globe key mapped to [ActionKeyType.language] for quick language
/// toggling, positioned to the left of the space bar.
class DesktopArabicKeyboardLayout extends KeyboardLayout {
  /// Creates a [DesktopArabicKeyboardLayout] instance.
  const DesktopArabicKeyboardLayout();
  ...
  List<KeyboardRow> get _defaultMode => [
    const KeyboardRow(
      keys: [
        OnscreenKeyboardKey.text(primary: 'ذ', secondary: 'ّ'),
